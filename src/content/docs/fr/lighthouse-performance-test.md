---
taskInputHash: 12a887d2eff6a22c
...
>
> 2\. Cliquez sur les trois points en haut à droite de la fenêtre du navigateur, puis sélectionnez "Plus d'outils" puis "Outils de développement" ou utilisez simplement le raccourci clavier "Ctrl+Shift+I" (Windows, Linux) ou "Command+Option+I" (macOS).
>
...
>
> 5\. Une fois que Lighthouse a terminé son analyse, vous verrez un rapport avec des scores et des recommandations pour améliorer la performance, l'accessibilité et d'autres aspects de votre site web.
>
